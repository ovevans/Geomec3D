...
for i in range(len(plottedSteps)):
	...
	if i == 0:
		plt.plot([gcol.exactPressureSolution(z, tExact)/1e3 for z in zExact], zExact, "-", color="grey", label="Exact")
		...
		plt.plot([gcol.exactPressureSolution(z, tExact)/1e3 for z in zExact], zExact, "-", color="grey")
...
for i in range(len(plottedSteps)):
	...
	plt.plot([gcol.exactDisplacementSolution(z, tExact)*1e3 for z in zExact], zExact, "-", color="grey")
